...
export default function Section3() {
  return (
    <Box as={'section'} maxW={"8xl"} minH={'100vh'}  pt={"20px"}>
        <Flex ml={"9.8%"} justify="space-between" mt={{base:'10', lg:'100'}} direction={{ base: 'column', md: 'row' }}>
            <Box  w={"574"}pr={"10px"} mt={{base: '100', lg:'5'}}>   
            ...
            <Text fontSize={{ base: 'md', md: 'sm', lg: 'lg' }} >Build your financial literacy within a transparent community. Follow other investors, 
                ...
                <Button size={'lg'} bg={'#00D0D0'} borderRadius={'30'} color={'#FFFFFF'} my={"30px"}> Get Started</Button>
            </Box>
            <Box mr={"140"}>
                <Image 
                src={illu3}
