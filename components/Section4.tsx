...
export default function Section4() {
  return (
    <Box  as={'section'}  maxW={"8xl"} minH={'100vh'} pt={"20px"}>
        <Flex justify="space-between" ml={"9.8%"}  direction={{ base: 'column', md: 'row' }}>
            <Box>
                <Image
                src={illu4}
                alt={"Illustration 4"}
            ...
            <Box mt={50} pl={"60px"}>
                ...
                <Text fontSize={{ base: 'md', md: 'sm', lg: 'lg' }} mt={{base: '16', lg:'25'}}>Build your financial literacy within a transparent community. Follow other investors, 
                ...
                <Button bg={'#00D0D0'} borderRadius={'30'} color={'#FFFFFF'} my={"20px"}>Learn More</Button>
            </Box>
        </Flex>
    </Box>
  )
