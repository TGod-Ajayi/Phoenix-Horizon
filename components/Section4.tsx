    ...
    <Box as={"section"} maxW={"8xl"} minH={"100vh"} pt={"20px"}>
      ...
      >
        <Box mr={{ base: "", lg: "20px" }} mt={"10"}>
          <Image src={illu4} alt={"Illustration 4"} width={900} height={1100} />
        </Box>
        <Box mt={50}>
          <Heading
          ...
          <Heading
            ...
            color={"#082854"}
          >
            Set Challenges and track your progress
          </Heading>
          <Text
          ...
          >
            ...
            other investors, share insights with people from different
            professional backgrounds, and never be alone with your charts &
            numbers.
          </Text>
          <Text
            fontSize={{ base: "md", md: "sm", lg: "lg" }}
